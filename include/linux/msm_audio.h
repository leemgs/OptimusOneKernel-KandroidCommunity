...
typedef enum {
  VOC_CODEC_SPEAKER_MEDIA					= 0,  		
  VOC_CODEC_STEREO_HEADSET_LOOPBACK		    = 1, 	 	
  VOC_CODEC_STEREO_HEADSET					= 2,  	
  VOC_CODEC_STEREO_HEADSET_MEDIA			= 3,  	
  VOC_CODEC_STEREO_HEADSET_WITHOUT_MIC		= 4,  	
  VOC_CODEC_ON_CHIP_0						= 5,		
  VOC_CODEC_SPEAKER_PHONE					= 6,  	
  VOC_CODEC_SPEAKER_HEADSET				    = 7,  	
  VOC_CODEC_VOICE_RECORDER					= 8,
  VOC_CODEC_FM_RADIO_HEADSET_MEDIA			= 9,     
  VOC_CODEC_FM_RADIO_SPEAKER_MEDIA			= 10,   
  VOC_CODEC_OFF_BOARD			    		= 11,
  VOC_CODEC_BT_HEADSET					    = 12, 	
  VOC_CODEC_A2DP_BT_HEADSET					= 13, 	
  VOC_CODEC_TTY_ON_CHIP_1						= 14,	
  VOC_CODEC_TTY_VCO 							= 15,	
  VOC_CODEC_TTY_HCO 							= 16,	
  VOC_CODEC_TTY_OFF_BOARD						= 17,	
  VOC_CODEC_RX_EXT_SDAC_TX_INTERNAL 			= 18,	
  VOC_CODEC_IN_STEREO_SADC_OUT_MONO_HANDSET 	= 19,	
  VOC_CODEC_IN_STEREO_SADC_OUT_STEREO_HEADSET	= 20,	
  VOC_CODEC_TX_INT_SADC_RX_EXT_AUXPCM			= 21,	 
  VOC_CODEC_EXT_STEREO_SADC_OUT_MONO_HANDSET	= 22,	
  VOC_CODEC_EXT_STEREO_SADC_OUT_STEREO_HEADSET	= 23,	
  VOC_CODEC_USB 								= 24,	
  VOC_CODEC_STEREO_USB							= 25,	
  VOC_CODEC_ON_CHIP_0_DUAL_MIC					= 26,	
  VOC_CODEC_MAX 								= 27,
  VOC_CODEC_NONE								= 28,		  
