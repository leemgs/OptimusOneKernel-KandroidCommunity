...
#define AT91_DDRSDRC_MR		(AT91_DDRSDRC + 0x00)	
...
#define AT91_DDRSDRC_RTR	(AT91_DDRSDRC + 0x04)	
#define		AT91_DDRSDRC_COUNT	(0xfff << 0)		

#define AT91_DDRSDRC_CR		(AT91_DDRSDRC + 0x08)	
...
#define AT91_DDRSDRC_T0PR	(AT91_DDRSDRC + 0x0C)	
...
#define AT91_DDRSDRC_T1PR	(AT91_DDRSDRC + 0x10)	
...
#define AT91_DDRSDRC_LPR	(AT91_DDRSDRC + 0x18)	
...
#define AT91_DDRSDRC_MDR	(AT91_DDRSDRC + 0x1C)	
...
#define AT91_DDRSDRC_DLLR	(AT91_DDRSDRC + 0x20)	
