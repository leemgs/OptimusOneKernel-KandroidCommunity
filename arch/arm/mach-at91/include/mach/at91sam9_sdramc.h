...
#define AT91_SDRAMC_MR		(AT91_SDRAMC + 0x00)	
...
#define AT91_SDRAMC_TR		(AT91_SDRAMC + 0x04)	
#define		AT91_SDRAMC_COUNT	(0xfff << 0)		

#define AT91_SDRAMC_CR		(AT91_SDRAMC + 0x08)	
...
#define AT91_SDRAMC_LPR		(AT91_SDRAMC + 0x10)	
...
#define AT91_SDRAMC_IER		(AT91_SDRAMC + 0x14)	
#define AT91_SDRAMC_IDR		(AT91_SDRAMC + 0x18)	
#define AT91_SDRAMC_IMR		(AT91_SDRAMC + 0x1C)	
#define AT91_SDRAMC_ISR		(AT91_SDRAMC + 0x20)	
#define		AT91_SDRAMC_RES		(1 << 0)		

#define AT91_SDRAMC_MDR		(AT91_SDRAMC + 0x24)	
