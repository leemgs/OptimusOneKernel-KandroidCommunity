...
static struct gpio_event_direct_entry lu3100_keypad_switch_map[] = {
	{ GPIO_VOL_UP,       	KEY_VOLUMEUP   	    },
	{ GPIO_VOL_DOWN,       	KEY_VOLUMEDOWN	    },
};


static int lu3100_gpio_event_input_func(struct input_dev *input_dev,
...
static int lu3100_gpio_keypad_power(
...
static struct gpio_event_input_info lu3100_keypad_switch_info = {
	.info.func = lu3100_gpio_event_input_func,
	.flags = 0,
	.type = EV_KEY,
	.keymap = lu3100_keypad_switch_map,
	.keymap_size = ARRAY_SIZE(lu3100_keypad_switch_map)
};

static struct gpio_event_info *lu3100_keypad_info[] = {
	&lu3100_keypad_switch_info.info,
};

static struct gpio_event_platform_data lu3100_keypad_data = {
	.name		= "lu3100_keypad",
	.info		= lu3100_keypad_info,
	.info_count	= ARRAY_SIZE(lu3100_keypad_info),
	.power          = lu3100_gpio_keypad_power,
};

struct platform_device keypad_device_lu3100= {
	.name	= GPIO_EVENT_DEV_NAME,
	.id	= -1,
	.dev	= {
		.platform_data	= &lu3100_keypad_data,
	},
};


static int lu3100_reset_keys_up[] = {
	KEY_HOME,
	0
};

static struct keyreset_platform_data lu3100_reset_keys_pdata = {
	.keys_up = lu3100_reset_keys_up,
	.keys_down = {
...
struct platform_device lu3100_reset_keys_device = {
	.name = KEYRESET_NAME,
	.dev.platform_data = &lu3100_reset_keys_pdata,
};
...
static struct platform_device *lu3100_input_devices[] __initdata = {
	&hs_device,
	&keypad_device_lu3100,
	&lu3100_reset_keys_device,
...
static void __init lu3100_init_i2c_touch(int bus_num)
{
...
static void __init lu3100_init_i2c_acceleration(int bus_num)
{
...
static void __init lu3100_init_i2c_prox_ecom(int bus_num)
{
...
{
	platform_add_devices(lu3100_input_devices, ARRAY_SIZE(lu3100_input_devices));

	lge_add_gpio_i2c_device(lu3100_init_i2c_touch);
	lge_add_gpio_i2c_device(lu3100_init_i2c_acceleration);
	lge_add_gpio_i2c_device(lu3100_init_i2c_prox_ecom);
}
