...
static struct android_vibrator_platform_data ku3700_vibrator_data = {
	...
	.pwn_set = ku3700_vibrator_pwn_set,
...
static int ku3700_gpio_earsense_work_func(void)
{
	int state;
	int gpio_value;
...
static char *ku3700_gpio_earsense_print_state(int state)
{
	return ear_state_string[state];
}

static int ku3700_gpio_earsense_sysfs_store(const char *buf, size_t size)
{
	int state;
...
static unsigned ku3700_earsense_gpios[] = {
	GPIO_EAR_SENSE,
};

static struct lge_gpio_switch_platform_data ku3700_earsense_data = {
	.name = "h2w",
	.gpios = ku3700_earsense_gpios,
	.num_gpios = ARRAY_SIZE(ku3700_earsense_gpios),
	.irqflags = IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING,
	.wakeup_flag = 1,
	.work_func = ku3700_gpio_earsense_work_func,
	.print_state = ku3700_gpio_earsense_print_state,
	.sysfs_store = ku3700_gpio_earsense_sysfs_store,
};

static struct platform_device ku3700_earsense_device = {
	.name   = "lge-switch-gpio",
	.id = 1,
	.dev = {
		.platform_data = &ku3700_earsense_data,
	},
};
