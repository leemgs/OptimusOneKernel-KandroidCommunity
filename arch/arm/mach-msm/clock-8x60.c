...
static struct reg_init {
	...
	{PLL0_MODE_REG, B(0), 0},     
	{PLL0_L_VAL_REG, 0xFF,   48}, 
	{PLL0_M_VAL_REG, 0x7FFFF, 8}, 
	{PLL0_N_VAL_REG, 0x7FFFF, 9}, 
	
	{PLL0_MODE_REG, B(4)|B(1), B(4)|B(1), 10},
	
	{PLL0_CONFIG_REG, 0xFFFFFFFF, 0x14580},
	{PLL0_MODE_REG, B(2), B(2)}, 
	{PLL0_MODE_REG, B(0), B(0)}, 

	
	{PLL1_MODE_REG, B(0), 0},      
	{PLL1_L_VAL_REG, 0x3FF,   29}, 
	{PLL1_M_VAL_REG, 0x7FFFF, 17}, 
	{PLL1_N_VAL_REG, 0x7FFFF, 27}, 
	
	{PLL1_MODE_REG, B(4)|B(1), B(4)|B(1), 10},
	
	{PLL1_CONFIG_REG, 0xFFFFFFFF, 0x00C22080},
	{PLL1_MODE_REG, B(2), B(2)}, 
	{PLL1_MODE_REG, B(0), B(0)}, 

	
	{PLL2_MODE_REG, B(0), 0},         
	{PLL2_L_VAL_REG, 0x3FF,       7}, 
	{PLL2_M_VAL_REG, 0x7FFFF,  6301}, 
	{PLL2_N_VAL_REG, 0x7FFFF, 13500}, 
	
	{PLL2_MODE_REG, B(4)|B(1), B(4)|B(1), 10},
	
	{PLL2_CONFIG_REG, 0xFFFFFFFF, 0x00E02080},
	{PLL2_MODE_REG, B(2), B(2)}, 
	{PLL2_MODE_REG, B(0), B(0)}, 

	
	{LCC_PRI_PLL_CLK_CTL_REG, B(0), B(0)}, 
	{LCC_PLL0_MODE_REG, B(0), 0},          
	{LCC_PLL0_L_VAL_REG, 0x3FF,     20},   
	{LCC_PLL0_M_VAL_REG, 0x7FFFF,   28},   
	{LCC_PLL0_N_VAL_REG, 0x7FFFF, 1125},   
	
	{LCC_PLL0_MODE_REG, B(4)|B(1), B(4)|B(1), 10},
	
	{LCC_PLL0_CONFIG_REG, 0xFFFFFFFF, 0x00822080},
	{LCC_PLL0_MODE_REG, B(2), B(2)}, 
	{LCC_PLL0_MODE_REG, B(0), B(0)}, 
