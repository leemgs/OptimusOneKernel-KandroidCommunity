...
static const struct clk_freq_tbl clk_tbl_lpa_codec[] = {
	F_RAW(1, SRC_MAX, 0,  0,  0, MSMC1_END), 
	F_RAW(2, SRC_MAX, 0,  1,  0, MSMC1_END), 
	F_RAW(3, SRC_MAX, 0,  2,  0, MSMC1_END), 
	F_RAW(4, SRC_MAX, 0,  3,  0, MSMC1_END), 
	F_END,
};
...
#define MNCNTR_MODE		BVAL(6, 5, 0x2) 
...
static unsigned xo_votes[NUM_XO]; 
...
static const struct reg_init {
	...
	{REG(EMDH_NS), BM(18, 17) , BVAL(18, 17, 0x3)}, 
	{REG(PMDH_NS), BM(18, 17), BVAL(18, 17, 0x3)}, 
	
	{REG(MI2S_RX_NS), B(14), 0x0},
	
	{REG(MI2S_TX_NS), B(14), 0x0},
	{REG(MI2S_NS), B(14), 0x0}, 
	...
	{REG(0x02E4), 0xF, 0x7}, 
	{REG(MDC_NS), 0x3, 0x3}, 
	{REG(SDAC_NS), BM(15, 14), 0x0}, 
	
	{REG(UART_NS), BM(26, 25) | BM(2, 0), 0x0},
	{REG(MDP_VSYNC_REG), 0xC, 0x4}, 
	
	{REG(HDMI_NS), 0x7, 0x0},
	{REG(TV_NS), BM(15, 14), 0x0}, 
