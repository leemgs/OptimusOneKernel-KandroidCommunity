				...
				[PERF_COUNT_HW_CACHE_RESULT_MAX] =
{
 ...
 [ C(LL  ) ] = {
	[ C(OP_READ) ] = {
		[ C(RESULT_ACCESS) ] = 0x0324, 
		[ C(RESULT_MISS)   ] = 0x0224, 
	},
	[ C(OP_WRITE) ] = {
		[ C(RESULT_ACCESS) ] = 0x0c24, 
		[ C(RESULT_MISS)   ] = 0x0824, 
	},
	[ C(OP_PREFETCH) ] = {
		[ C(RESULT_ACCESS) ] = 0x4f2e, 
		[ C(RESULT_MISS)   ] = 0x412e, 
	},
 },
 [ C(DTLB) ] = {
	[ C(OP_READ) ] = {
