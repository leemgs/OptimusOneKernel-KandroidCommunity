...
static iw_handler p80211wext_handlers[] = {
	(iw_handler) p80211wext_siwcommit,	
	(iw_handler) p80211wext_giwname,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) p80211wext_siwfreq,	
	(iw_handler) p80211wext_giwfreq,	
	(iw_handler) p80211wext_siwmode,	
	(iw_handler) p80211wext_giwmode,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) p80211wext_giwrange,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) p80211wext_siwspy,	
	(iw_handler) p80211wext_giwspy,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) p80211wext_giwap,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) p80211wext_siwscan,	
	(iw_handler) p80211wext_giwscan,	
	(iw_handler) p80211wext_siwessid,	
	(iw_handler) p80211wext_giwessid,	
	(iw_handler) NULL,	
	(iw_handler) p80211wext_giwessid,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) p80211wext_giwrate,	
	(iw_handler) p80211wext_siwrts,	
	(iw_handler) p80211wext_giwrts,	
	(iw_handler) p80211wext_siwfrag,	
	(iw_handler) p80211wext_giwfrag,	
	(iw_handler) p80211wext_siwtxpow,	
	(iw_handler) p80211wext_giwtxpow,	
	(iw_handler) p80211wext_siwretry,	
	(iw_handler) p80211wext_giwretry,	
	(iw_handler) p80211wext_siwencode,	
	(iw_handler) p80211wext_giwencode,	
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	...
	(iw_handler) NULL,	
	(iw_handler) NULL,	
	(iw_handler) p80211_wext_set_iwauth,	
	(iw_handler) p80211_wext_get_iwauth,	

	(iw_handler) p80211wext_set_encodeext,	
	(iw_handler) p80211wext_get_encodeext,	
	(iw_handler) NULL,	
};
