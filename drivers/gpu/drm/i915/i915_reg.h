...
#define   DPLL_FPA01_P1_POST_DIV_MASK_IGD	0x00ff8000 
...
#define I915_START_VBLANK_INTERRUPT_ENABLE	(1UL<<18)	
...
#define I915_START_VBLANK_INTERRUPT_STATUS	(1UL<<2)	
