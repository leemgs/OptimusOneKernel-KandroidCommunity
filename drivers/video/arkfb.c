...
static int arkfb_set_par(struct fb_info *info)
{
	...
	case 0:
		...
		vga_wseq(NULL, 0x11, 0x10); 
		svga_wcrt_mask(0x46, 0x00, 0x04); 
		dac_set_mode(par->dac, DAC_PSEUDO8_8);
