...
#define VCD_I_FRAME_RATE  (VCD_START_BASE + 0x100)
#define VCD_I_TARGET_BITRATE (VCD_START_BASE + 0x101)
#define VCD_I_MULTI_SLICE    (VCD_START_BASE + 0x102)
#define VCD_I_ENTROPY_CTRL   (VCD_START_BASE + 0x103)
#define VCD_I_DEBLOCKING     (VCD_START_BASE + 0x104)
#define VCD_I_RATE_CONTROL   (VCD_START_BASE + 0x105)
#define VCD_I_QP_RANGE      (VCD_START_BASE + 0x106)
#define VCD_I_SESSION_QP    (VCD_START_BASE + 0x107)
#define VCD_I_INTRA_PERIOD   (VCD_START_BASE + 0x108)
#define VCD_I_VOP_TIMING     (VCD_START_BASE + 0x109)
#define VCD_I_SHORT_HEADER   (VCD_START_BASE + 0x10A)
#define VCD_I_SEQ_HEADER    (VCD_START_BASE + 0x10B)
#define VCD_I_HEADER_EXTENSION   (VCD_START_BASE + 0x10C)
#define VCD_I_INTRA_REFRESH  (VCD_START_BASE + 0x10D)
#define VCD_I_POST_FILTER    (VCD_START_BASE + 0x200)
#define VCD_I_PROGRESSIVE_ONLY (VCD_START_BASE + 0x201)
