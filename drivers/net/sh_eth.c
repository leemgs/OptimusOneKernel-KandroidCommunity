...
static void sh_eth_error(struct net_device *ndev, int intr_status)
{
	...
	if (intr_status & EESR_ECI) {
		...
		ctrl_outl(felic_stat, ioaddr + ECSR);	
...
#if defined(CONFIG_CPU_SUBTYPE_SH7763)
	mdp->stats.tx_carrier_errors += ctrl_inl(ioaddr + CERCR);
	ctrl_outl(0, ioaddr + CERCR);	
	mdp->stats.tx_carrier_errors += ctrl_inl(ioaddr + CEECR);
	ctrl_outl(0, ioaddr + CEECR);	
#else
...
{
	ctrl_outl(0, ioaddr + TSU_FWEN0);	
	ctrl_outl(0, ioaddr + TSU_FWEN1);	
	ctrl_outl(0, ioaddr + TSU_FCM);	
...
#if defined(CONFIG_CPU_SUBTYPE_SH7763)
	ctrl_outl(0, ioaddr + TSU_QTAG0);	
	ctrl_outl(0, ioaddr + TSU_QTAG1);	
#else
	ctrl_outl(0, ioaddr + TSU_QTAGM0);	
	ctrl_outl(0, ioaddr + TSU_QTAGM1);	
#endif
	ctrl_outl(0, ioaddr + TSU_FWSR);	
	ctrl_outl(0, ioaddr + TSU_FWINMK);	
	ctrl_outl(0, ioaddr + TSU_TEN);	
	ctrl_outl(0, ioaddr + TSU_POST1);	
	ctrl_outl(0, ioaddr + TSU_POST2);	
	ctrl_outl(0, ioaddr + TSU_POST3);	
	ctrl_outl(0, ioaddr + TSU_POST4);	
}
#endif 
