...
#define UCC_GETH_SCHEDULER_ALIGNMENT		4	
...
#define UCC_GETH_UTFS_GIGA_INIT                 8192	
#define UCC_GETH_UTFET_GIGA_INIT                4096	
#define UCC_GETH_UTFTT_GIGA_INIT                0x400	
...
struct enet_addr_container {
	u8 address[ENET_NUM_OCTETS_PER_ADDRESS];	
...
struct ucc_geth_private {
	...
	u8 paddr[NUM_OF_PADDRS][ENET_NUM_OCTETS_PER_ADDRESS];	
