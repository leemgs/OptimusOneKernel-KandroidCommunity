...
#define IXGBE_MSCA_READ              0x08000000 
...
#define IXGBE_EEPROM_READ_REG_DATA   16   
#define IXGBE_EEPROM_READ_REG_DONE   2    
#define IXGBE_EEPROM_READ_REG_START  1    
#define IXGBE_EEPROM_READ_ADDR_SHIFT 2    
