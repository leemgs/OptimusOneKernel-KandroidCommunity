...
#define CR47  CTL_REG(0x00BC)	
#define CR48  CTL_REG(0x00C0)
#define CR49  CTL_REG(0x00C4)
#define CR50  CTL_REG(0x00C8)
#define CR51  CTL_REG(0x00CC)	
#define CR52  CTL_REG(0x00D0)	
#define CR53  CTL_REG(0x00D4)	
...
#define CR65  CTL_REG(0x0104) 
#define CR66  CTL_REG(0x0108) 
#define CR67  CTL_REG(0x010C) 
#define CR68  CTL_REG(0x0110) 
