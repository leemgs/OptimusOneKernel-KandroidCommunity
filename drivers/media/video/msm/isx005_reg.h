...
init_reg_settings_array[] = {
	...
	{0x034A, 0x11   ,BYTE_LEN},		
	{0x034C, 0x30   ,BYTE_LEN},		
	{0x4044, 0x8C0A ,WORD_LEN},		
	{0x4046, 0x1815 ,WORD_LEN},		
	{0x402B, 0x4B   ,BYTE_LEN},	        
	{0x402C, 0x9600 ,WORD_LEN},		
	{0x4060, 0x8C0A ,WORD_LEN},		
	{0x4062, 0x1815 ,WORD_LEN},		
	{0x403E, 0x041D ,WORD_LEN},		
	{0x4074, 0x0421 ,WORD_LEN},		
	{0x4040, 0xF71B ,WORD_LEN},		
	{0x4076, 0xF71F ,WORD_LEN},		
	{0x02A2, 0x2100 ,WORD_LEN},		
	{0x0364, 0x2100 ,WORD_LEN},		
	{0x02A4, 0x1000 ,WORD_LEN},		
	{0x02A6, 0x0800 ,WORD_LEN},		
	{0x02A8, 0x0000 ,WORD_LEN},		
	{0x4C14, 0xA001 ,WORD_LEN},		
	{0x4C1C, 0x4003 ,WORD_LEN},		
	{0x4C16, 0xA001 ,WORD_LEN},		
	{0x4C18, 0x8001 ,WORD_LEN},		
	{0x4C1A, 0xC000 ,WORD_LEN},		
	{0x000E, 0x12   ,BYTE_LEN},	  	
...
tuning_reg_settings_array[] = {	
	...
	{0x52AE,0x0022,WORD_LEN},
        
	{0x5400,0x0000,WORD_LEN},
        {0x5402,0x0000,WORD_LEN},
        {0x5404,0x0200,WORD_LEN},
        {0x5406,0x0900,WORD_LEN},
        {0x5408,0x1200,WORD_LEN},
        {0x540a,0x1D00,WORD_LEN},
        {0x540c,0x2700,WORD_LEN},
        {0x540e,0x2F00,WORD_LEN},
        {0x5410,0x3700,WORD_LEN},
        {0x5412,0x3F00,WORD_LEN},
        {0x5414,0x4600,WORD_LEN},
        {0x5416,0x4D00,WORD_LEN},
        {0x5418,0x5200,WORD_LEN},
        {0x541a,0x5700,WORD_LEN},
        {0x541c,0x5B00,WORD_LEN},
        {0x541e,0x6000,WORD_LEN},
        {0x5420,0x6300,WORD_LEN},
        {0x5422,0x6A00,WORD_LEN},
        {0x5424,0x5000,WORD_LEN},
        {0x5426,0x7B00,WORD_LEN},
        {0x5428,0xA500,WORD_LEN},
        {0x542a,0xC200,WORD_LEN},
        {0x542c,0xD800,WORD_LEN},
        {0x542e,0xEA00,WORD_LEN},
        {0x5430,0xF500,WORD_LEN},
        {0x5432,0xFF00,WORD_LEN},
        {0x5434,0x0401,WORD_LEN},
        
        {0x5436,0x0000,WORD_LEN},
        {0x5438,0x0100,WORD_LEN},
        {0x543a,0x0300,WORD_LEN},
        {0x543c,0x0C00,WORD_LEN},
        {0x543e,0x1500,WORD_LEN},
        {0x5440,0x2000,WORD_LEN},
        {0x5442,0x2A00,WORD_LEN},
        {0x5444,0x3200,WORD_LEN},
        {0x5446,0x3900,WORD_LEN},
        {0x5448,0x4100,WORD_LEN},
        {0x544a,0x4700,WORD_LEN},
        {0x544c,0x4D00,WORD_LEN},
        {0x544e,0x5200,WORD_LEN},
        {0x5450,0x5700,WORD_LEN},
        {0x5452,0x5B00,WORD_LEN},
        {0x5454,0x6000,WORD_LEN},
        {0x5456,0x6300,WORD_LEN},
        {0x5458,0x6A00,WORD_LEN},
        {0x545a,0x5000,WORD_LEN},
        {0x545c,0x7B00,WORD_LEN},
        {0x545e,0xA500,WORD_LEN},
        {0x5460,0xC200,WORD_LEN},
        {0x5462,0xD800,WORD_LEN},
        {0x5464,0xEA00,WORD_LEN},
        {0x5466,0xF500,WORD_LEN},
        {0x5468,0xFF00,WORD_LEN},
        {0x546a,0x0401,WORD_LEN},
        
        {0x546c,0x0000,WORD_LEN},
        {0x546e,0x0100,WORD_LEN},
        {0x5470,0x0300,WORD_LEN},
        {0x5472,0x0C00,WORD_LEN},
        {0x5474,0x1500,WORD_LEN},
        {0x5476,0x2000,WORD_LEN},
        {0x5478,0x2A00,WORD_LEN},
        {0x547a,0x3200,WORD_LEN},
        {0x547c,0x3900,WORD_LEN},
        {0x547e,0x4100,WORD_LEN},
        {0x5480,0x4700,WORD_LEN},
        {0x5482,0x4D00,WORD_LEN},
        {0x5484,0x5200,WORD_LEN},
        {0x5486,0x5700,WORD_LEN},
        {0x5488,0x5B00,WORD_LEN},
        {0x548a,0x6000,WORD_LEN},
        {0x548c,0x6300,WORD_LEN},
        {0x548e,0x6A00,WORD_LEN},
        {0x5490,0x5000,WORD_LEN},
        {0x5492,0x7B00,WORD_LEN},
        {0x5494,0xA500,WORD_LEN},
        {0x5496,0xC200,WORD_LEN},
        {0x5498,0xD800,WORD_LEN},
        {0x549a,0xEA00,WORD_LEN},
        {0x549c,0xF500,WORD_LEN},
        {0x549e,0xFF00,WORD_LEN},
        {0x54a0,0x0401,WORD_LEN},
        {0x54a2,0x1003,WORD_LEN},
        {0x54a4,0x0540,WORD_LEN},
        {0x54a6,0x1003,WORD_LEN},
        {0x54a8,0x0540,WORD_LEN},
        {0x54aa,0x1003,WORD_LEN},
        {0x54ac,0x0540,WORD_LEN},
        {0x54ae,0x0022,WORD_LEN},
	...
	{0x480E,0x5802,WORD_LEN}, 
	{0x4810,0x5802,WORD_LEN}, 
   ...
   {0x4872,0x0A00,WORD_LEN},         
    ...
    {0x4876, 0xAA00,WORD_LEN},       
    {0x4878, 0x1202,WORD_LEN},        
	...
	{0x46EC, 0x1F, BYTE_LEN},    
	{0x46ED, 0x14, BYTE_LEN},    
	...
	{0x4705, 0x41, BYTE_LEN},    
	{0x4706, 0x3D, BYTE_LEN},    
	{0x4707, 0x39, BYTE_LEN},    
	{0x4708,0x36  ,BYTE_LEN},  
	{0x4709, 0x33, BYTE_LEN},    
	{0x470A, 0x31, BYTE_LEN},    
	{0x470B, 0x2F, BYTE_LEN},    
	{0x470C, 0x2D, BYTE_LEN},    
	{0x470D, 0x2B, BYTE_LEN},    
	{0x470E, 0x2C, BYTE_LEN},    
	...
	{0x472B, 0x4A, BYTE_LEN},    
	{0x472C, 0x46, BYTE_LEN},    
	{0x472D, 0x43, BYTE_LEN},    
	{0x472E, 0x40, BYTE_LEN},    
	{0x472F, 0x3D, BYTE_LEN},    
	{0x4730, 0x3C, BYTE_LEN},    
	{0x4731, 0x3A, BYTE_LEN},    
	{0x4732, 0x38, BYTE_LEN},    
   ...
   {0x01BE,0x02  ,BYTE_LEN}, 
   {0x01BF,0x03  ,BYTE_LEN}, 
   {0x01C0,0x03  ,BYTE_LEN}, 
	...
	{0x4F38,0x13,BYTE_LEN},
	{0x4F39,0x17,BYTE_LEN},
	{0x4F3A,0x19,BYTE_LEN},
	{0x4F3B,0x13,BYTE_LEN},
	...
	{0x5888,0x1200,WORD_LEN},
	{0x588A,0x1100,WORD_LEN},
	{0x588C,0x0600,WORD_LEN},
	{0x588E,0x2d00,WORD_LEN},
	...
	{0x001D, 0x00,BYTE_LEN},		
	{0x0020, 0x00,BYTE_LEN}, 	  
	{0x0014, 0x00,BYTE_LEN},		
};

static struct isx005_register_address_value_pair const
preview_mode_reg_settings_array[] = {
    {0x588E,0x1200,WORD_LEN},  
    {0x02A4, 0x0700, WORD_LEN},		
	{0x01be, 0x02,BYTE_LEN},	
	{0x001C, 0x00 ,BYTE_LEN},   	
#if defined (CONFIG_ISX005_ROTATION_180)
...
#define ISX005_CAPTURE_SIZE_WIDTH		0x0008	
#define ISX005_CAPTURE_SIZE_HIGHT		0x0006	
...
snapshot_mode_reg_settings_array[] = {
	...
	{0x001D, 0x00  ,BYTE_LEN},			
#if defined (CONFIG_ISX005_ROTATION_180)	
	{0x0020, 0x03  ,BYTE_LEN},			
#else
	{0x0020, 0x00  ,BYTE_LEN},			
#endif
	{0x0024, ISX005_CAPTURE_SIZE_WIDTH,WORD_LEN},		
	{0x002A, ISX005_CAPTURE_SIZE_HIGHT,WORD_LEN},		
	{0x0014, 0x00  ,BYTE_LEN},	     	
	{0x00FC, 0x1F  ,BYTE_LEN},	     	
...
af_macro_mode_reg_settings_array[] =
{
	...
	{0x01D3, 0x02, BYTE_LEN},	
	{0x01D4, 0x02, BYTE_LEN},	
	{0x01D5, 0x02, BYTE_LEN},	
	{0x01D6, 0x02, BYTE_LEN},	
	{0x01D7, 0x02, BYTE_LEN},	
	{0x01D8, 0x02, BYTE_LEN},	
	{0x01D9, 0x02, BYTE_LEN},	
	{0x01DA, 0x02, BYTE_LEN},	
	{0x01DB, 0x02, BYTE_LEN},	
	{0x01DC, 0x02, BYTE_LEN},	
	{0x01DD, 0x02, BYTE_LEN},	
	{0x01DE, 0x02, BYTE_LEN},	
	{0x002E, 0x02, BYTE_LEN},
	{0x0012, 0x01, BYTE_LEN},
	{0x4850, 0x01, BYTE_LEN},
};
...
af_manual_mode_reg_settings_array[] =
{
	...
	{0x4884, 0x00, BYTE_LEN},
	{0x01D3, 0x08, BYTE_LEN},	
	{0x01D4, 0x08, BYTE_LEN},	
	{0x01D5, 0x08, BYTE_LEN},	
	{0x01D6, 0x08, BYTE_LEN},	
	{0x01D7, 0x08, BYTE_LEN},	
	{0x01D8, 0x08, BYTE_LEN},	
	{0x01D9, 0x08, BYTE_LEN},	
	{0x01DA, 0x08, BYTE_LEN},	
	{0x01DB, 0x08, BYTE_LEN},	
	{0x01DC, 0x08, BYTE_LEN},	
	{0x01DD, 0x08, BYTE_LEN},	
	{0x01DE, 0x08, BYTE_LEN},	
	{0x002E, 0x02, BYTE_LEN},
	{0x0012, 0x01, BYTE_LEN},
...
af_start_low_light_reg_settings_array[] =
{
	...
	{0x480E,0x2B00,WORD_LEN}, 
	{0x4810,0x2B00,WORD_LEN}, 
	{0x002E, 0x00 ,BYTE_LEN},		
	{0x0012, 0x01 ,BYTE_LEN},		
};
	...
	scene_mode_portrait_reg_settings_array[] = 
{
	...
	{0x486c,0x1E00,WORD_LEN}, 
	{0x4870,0x1E00,WORD_LEN},
	{0x0100, 0x01, BYTE_LEN},	
	{0x0062, 0x16, BYTE_LEN},	
    {0x4A00,0x0D05,WORD_LEN}, 
    {0x4A02,0x0000,WORD_LEN}, 
    {0x4016,0x6D23,WORD_LEN}, 
    {0x4018,0xca03,WORD_LEN}, 
	...
	scene_mode_landscape_reg_settings_array[] = 
{
	...
	{0x486c,0x1E00,WORD_LEN},  
	{0x4870,0x1E00,WORD_LEN},
	{0x0100, 0x02, BYTE_LEN},	
	{0x0062, 0x2A, BYTE_LEN},	
    {0x4A00,0x0D05,WORD_LEN}, 
    {0x4A02,0x0000,WORD_LEN}, 
    {0x4016,0x6D23,WORD_LEN}, 
    {0x4018,0xca03,WORD_LEN}, 
	...
	scene_mode_sports_reg_settings_array[] =
{
	...
	{0x486c,0x1E00,WORD_LEN},
	{0x4870,0x1E00,WORD_LEN},
	{0x0100, 0x03, BYTE_LEN},	
	{0x0062, 0x20, BYTE_LEN},	
	{0x4A00, 0x0D05, WORD_LEN},	
	{0x4A02, 0x0000, WORD_LEN},	
	{0x4016,0xff15, WORD_LEN},	
	{0x4018, 0x9604, WORD_LEN},	
    {0x401A,0x3608,WORD_LEN}, 
    {0x401C,0xcd00,WORD_LEN}, 
    {0x401E,0x0504,WORD_LEN}, 
    {0x4020,0x3202,WORD_LEN}, 
};
	...
	scene_mode_night_reg_settings_array[] = 
{
    ...
    {0x401A,0x0002,WORD_LEN}, 
    {0x401C,0xCA03,WORD_LEN}, 
	{0x401E, 0xF307, WORD_LEN},	
	{0x4020, 0xFF01, WORD_LEN},	
	{0x0130, 0x01, BYTE_LEN},	
	{0x0131, 0x8D, BYTE_LEN},	
	{0x0062, 0x20, BYTE_LEN},	
	{0x0100, 0x09, BYTE_LEN},	
};
