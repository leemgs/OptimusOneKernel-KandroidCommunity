...
static void usb_reset(struct usb_info *ui)
{
    ...
    if( nCableType == LG_FACTORY_CABLE_TYPE || nCableType == LG_FACTORY_CABLE_130K_TYPE) 
...
#if defined(CONFIG_USB_SUPPORT_LGE_FACTORY_USB)
  if(desc_device.idProduct == 0x618F)     
  { 
...
static int __init usb_probe(struct platform_device *pdev)
{
	...
	if( tempCableID == LG_FACTORY_CABLE_TYPE || tempCableID == LG_FACTORY_CABLE_130K_TYPE)  
