...
enum {
	HSUSB_DEBUG_NORMAL   = 1U << 0,  
	HSUSB_DEBUG_ISR_WQ   = 1U << 1,  
	HSUSB_DEBUG_PM       = 1U << 2,  
	HSUSB_DEBUG_INIT     = 1U << 3,  
	HSUSB_DEBUG_COMPO    = 1U << 4,  
	HSUSB_DEBUG_EP       = 1U << 5,  
	HSUSB_DEBUG_FUNCTION = 1U << 6,  
};
...
#define LG_DEFAULT_PID		0x618F 		
#define LG_ADB_ON_PID		0x618E		
#define LG_FACTORY_PID     	0x6000		

static int pid = LG_DEFAULT_PID;   	 
#else	
